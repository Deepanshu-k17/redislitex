...
TcpServer::TcpServer(int port) : port_(port), running_(true) {}
...
void TcpServer::start()
{
  ...
  std::cout << "RedisLiteX listening on port " << port_ << "\n";

  std::thread cleanup_thread(&TcpServer::cleanupExpiredKeys, this);
...
void TcpServer::cleanupExpiredKeys()
{
  while (running_)
  {
